...
[![Version](https://img.shields.io/badge/Version-1.16.2-purple)](CHANGELOG.md)
...
**v1.16.2** — Skips GitHub Pages deployment polling on feature branches so branch tests do not wait for a main-only Pages workflow.
