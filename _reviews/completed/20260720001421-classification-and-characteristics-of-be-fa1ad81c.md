...
- 인디아 페일 에일에서 인디아라는 단어는 우리가 알고있는 인도라는 국가의 의미에서 온건지에 대한 간단한 설명 첨가
- 라거라는 맥주에서 Bock이라는건 Shiner Bock이라고 하는 맥주가 그 중 하나를 의미하는건지 설명
- 스타우트 섹션에서 포터 스타일과 밀접한 관련이 있다는데 구체적인 설명 추가가 필요함. 어떻게 밀접한 관련이 있고 무엇이 서로 다른건지
