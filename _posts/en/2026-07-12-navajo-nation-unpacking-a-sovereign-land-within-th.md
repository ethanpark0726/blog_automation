---
layout: post
title: "Navajo Nation: Unpacking a Sovereign Land Within the U.S."
...
```mermaid
graph TD
    A["Navajo Nation (Naabeehó Bináhásdzo)"] --> B["Five Agencies"]
    B --> C1["Agency 1"]
    B --> C2["Agency 2"]
    B --> C3["Agency 3"]
    B --> C4["Agency 4"]
    B --> C5["Agency 5"]
    C1 --> D1["Chapter A (Local Government)"]
    C1 --> D2["Chapter B (Local Government)"]
    C2 --> E1["Chapter X (Local Government)"]
    C2 --> E2["Chapter Y (Local Government)"]
